...
export const exerciseSchema = z.object({
     ...
     */
    muscleGroups: z
        .array(z.enum(['chest', 'back', 'shoulders', 'arms', 'legs', 'core', 'full-body'], {
        error: 'muscleGroups deve contenere solo: "chest", "back", "shoulders", "arms", "legs", "core", "full-body". Mappa "triceps"/"biceps" → "arms", "quads"/"hamstrings" → "legs", etc.',
    }))
        .optional(),
