...
export const AIGeneratedFoodSchema = z.object({
  ...
  macros: AIMacrosPer100gSchema.describe(
    'Valori nutrizionali PER 100G di alimento CRUDO (non per la quantità)'
  ),
  ...
  description: z
    ...
    .describe(
      'Descrizione dettagliata: stato preparazione, caratteristiche nutrizionali, uso tipico'
    ),
 ...
 */
export function validateAIGeneratedFood(input: unknown): AIGeneratedFood {
 ...
 */
export function safeValidateAIGeneratedFood(input: unknown) {
 ...
 */
export function validateFoodToCreate(input: unknown): FoodToCreate {
 ...
 */
export function aiGeneratedFoodToFoodToCreate(food: AIGeneratedFood): FoodToCreate {
  return {
    name: food.name.trim(),
    macrosPer100g: {
