 ...
 */
export function validateOneRepMaxInput(input: unknown): OneRepMaxInput {
 ...
 */
export function safeValidateOneRepMaxInput(input: unknown) {
 ...
 */
export function validateCatalogExerciseReference(input: unknown): CatalogExerciseReference {
