...
export interface PlanningSubSubTask {
  ...
  status: TaskStatus;
  result?: unknown; // Risultato parziale (pasto generato)
  error?: string;
  startedAt?: Date;
  completedAt?: Date;
}
...
export interface PlanningSubTask {
  ...
  dayName: string;
  status: TaskStatus;
  result?: unknown; // Risultato parziale (giorno generato)
  error?: string;
  startedAt?: Date;
  completedAt?: Date;
  subSubTasks?: PlanningSubSubTask[]; // Pasti come sub-sub-task
}
...
export interface PlanningTask {
  ...
  result?: unknown; // Risultato parziale (settimana generata)
  error?: string;
  startedAt?: Date;
  completedAt?: Date;
}
