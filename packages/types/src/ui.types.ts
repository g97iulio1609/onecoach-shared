 ...
 */
export function isUserProfileResponse(value: unknown): value is UserProfileResponse {
 ...
 */
export function isAgentStreamRequest(value: unknown): value is AgentStreamRequest {
  if (typeof value !== 'object' || value === null) return false;
  const req = value as Record<string, unknown>;
  return (
    typeof req.agentType === 'string' &&
 ...
 */
export function createAgentStreamRequest(
  agentType: AgentStreamRequest['agentType'],
  userId: string,
  prompt: string,
  overrides: Partial<Omit<AgentStreamRequest, 'agentType' | 'userId' | 'prompt'>> = {}
): AgentStreamRequest {
  return {
    agentType,
    userId,
 ...
 */
export function createChatApiRequest(
