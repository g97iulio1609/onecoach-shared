...
export interface DraggableData {
  ...
  exerciseId?: string;
  // Context for determining valid drop zones
...
// ============================================================================
// Sensor Configuration (for touch/mouse/keyboard)
// ============================================================================
...
export interface TouchSensorConfig {
  activationDelay?: number; // ms for long-press
  activationTolerance?: number; // px movement tolerance
}
...
export interface MouseSensorConfig {
  activationConstraint?: {
    distance?: number; // px before drag starts
  };
}
