...
export declare function LoadingState({
  ...
  size,
  className,
}: LoadingStateProps): import('react/jsx-runtime').JSX.Element;
...
export declare function ErrorState({
  ...
  action,
  className,
}: ErrorStateProps): import('react/jsx-runtime').JSX.Element;
...
export declare function EmptyState({
  ...
  action,
  className,
}: EmptyStateProps): import('react/jsx-runtime').JSX.Element;
