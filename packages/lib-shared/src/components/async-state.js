...
export function LoadingState({ message = 'Caricamento...', size = 'md', className = '' }) {
  ...
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx(Loader2, { className: `mx-auto animate-spin text-blue-500 ${sizeClasses[size]}` }),
        message &&
          _jsx('p', {
...
export function ErrorState({
  ...
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      className: 'text-center',
      children: [
        _jsx(AlertCircle, { className: 'mx-auto h-12 w-12 text-red-500' }),
        _jsx('h3', {
        ...
        action && _jsx('div', { className: 'mt-4', children: action }),
        !action &&
          onRetry &&
          _jsx(Button, {
            onClick: onRetry,
...
export function EmptyState({ title, message, icon, action, className = '' }) {
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      className: 'text-center',
      children: [
        icon || _jsx(AlertTriangle, { className: 'mx-auto h-12 w-12 text-gray-400' }),
        _jsx('h3', {
          className: 'mt-4 text-lg font-semibold text-gray-900 dark:text-gray-100',
          children: title,
        }),
