 ...
 */
export function validateMacros(macros: Partial<Macros>): { valid: boolean; error?: string } {
  const requiredFields: (keyof Macros)[] = ['calories', 'protein', 'carbs', 'fats'];
 ...
 */
export function validateBodyFat(bodyFat: number): { valid: boolean; error?: string } {
 ...
 */
export function validateCircumference(circumference: number): { valid: boolean; error?: string } {
 ...
 */
export function validateExerciseWeight(weight: number): { valid: boolean; error?: string } {
 ...
 */
export function validateRestTime(seconds: number): { valid: boolean; error?: string } {
 ...
 */
export function validateNotes(notes: string, maxLength = 500): { valid: boolean; error?: string } {
