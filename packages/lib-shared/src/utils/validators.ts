 ...
 */
export function isValidWorkoutProgram(workout: Partial<WorkoutProgram>): boolean {
 ...
 * @returns true se valido
 */
export function isValidNutritionPlan(plan: Partial<NutritionPlan>): boolean {
 ...
 */
export function isValidMacros(macros: Partial<Macros>): boolean {
 ...
 * @returns true se valida
 */
export function isNonEmptyString(value: string, minLength: number = 1): boolean {
