...
export function validatePassword(
  password: string,
  requirements: PasswordRequirements = ADMIN_PASSWORD_REQUIREMENTS
...
export function getPasswordRequirementsMessage(
  ...
  if (requirements.requireUppercase) parts.push('una maiuscola');
  if (requirements.requireLowercase) parts.push('una minuscola');
  if (requirements.requireNumbers) parts.push('un numero');
  if (requirements.requireSpecialChars) parts.push('un carattere speciale');
