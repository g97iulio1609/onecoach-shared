 ...
 */
export declare function recalculateFoodMacros(
  food: Food,
  oldQuantity: number,
  newQuantity: number
): Macros;
 ...
 */
export declare function calculateCaloriesFromMacros(
  protein: number,
  carbs: number,
  fats: number
): number;
 ...
 */
export declare function calculateProportionalMacros(
  macros: Macros,
 ...
 */
export declare function validateMacroCoherence(
  actual: Macros,
  expected: Macros,
  tolerance?: number,
  context?: string
